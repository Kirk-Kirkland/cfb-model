...
def build(path,season,week,D,games_wk,ratings,G,proj,cur_logs,wx,prev):
    ...
    picks=[]
    for s in sel:
        if s['ou']>=60: continue  # skip total bets when market O/U is 60+
        a=abs(s['te'])
